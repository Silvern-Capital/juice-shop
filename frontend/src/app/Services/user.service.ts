...
export class UserService {
  ...
  oauthLogin (accessToken: string) {
    return this.http.post(this.hostServer + '/rest/user/oauth-login', { access_token: accessToken }).pipe(map((response: any) => response.authentication), catchError((err) => { throw err }))
  }
